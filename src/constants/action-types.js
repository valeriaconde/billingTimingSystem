...
export const CLIENTS_MAPPING_LOADED = "CLIENTS_MAPPING_LOADED";
export const LOADING_CLIENT_PROJECTS = "LOADING_CLIENT_PROJECTS";
export const CLIENT_PROJECTS_LOADED = "CLIENT_PROJECTS_LOADED";
export const LOADING_INVOICES = "LOADING_INVOICES";
export const INVOICES_LOADED = "INVOICES_LOADED";
export const LOADING_UNBILLED_TIMES = "LOADING_UNBILLED_TIMES";
export const UNBILLED_TIMES_LOADED = "UNBILLED_TIMES_LOADED";
export const LOADING_UNBILLED_EXPENSES = "LOADING_UNBILLED_EXPENSES";
export const UNBILLED_EXPENSES_LOADED = "UNBILLED_EXPENSES_LOADED";
export const LOADING_FIXED_FEE_PROJECTS = "LOADING_FIXED_FEE_PROJECTS";
export const FIXED_FEE_PROJECTS_LOADED = "FIXED_FEE_PROJECTS_LOADED";